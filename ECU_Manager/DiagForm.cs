    ...
    public partial class DiagForm : Form, IEcuEventHandler
    {
        ...
        private void InitParametersList()
        {
            ...
            foreach (FieldInfo fieldInfo in parametersFields)
            {
                ...
                if (fieldInfo.Name == "KnockSaturation") parameter.FloatFormat = "F3"; //&ecu_parameters.KnockSaturation, .title = "%s%0.3f"},
                ...
                if (fieldInfo.Name == "InjectionLag") parameter.FloatFormat = "F3"; //&ecu_parameters.InjectionLag, .title = "%s%0.3f"},
