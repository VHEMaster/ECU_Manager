        ...
        private void btnTableImport_Click(object sender, EventArgs e)
        {
            if (dlgImport.ShowDialog() == DialogResult.OK)
            {
                try
                {
                    ...
                    SynchronizedEvent();
                    MessageBox.Show($"Table import success.", "ACIS Manager", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                catch (Exception ex)
                {
                    MessageBox.Show($"Table import failed.\r\n{ex.Message}", "ACIS Manager", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
        }
        ...
        private void btnTableExport_Click(object sender, EventArgs e)
        {
            if(dlgExport.ShowDialog() == DialogResult.OK)
            {
                try
                {
                    ...
                    MessageBox.Show($"Table export success.", "ACIS Manager", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                catch (Exception ex)
                {
