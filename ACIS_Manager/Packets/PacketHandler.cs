...
using ACIS_Manager.Tools;
using ACIS_Manager.Packets;
...
namespace ACIS_Manager.Packets
{
    public class PacketHandler
    {
        ...
        {
            PK_GeneralStatusRequest packet = new PK_GeneralStatusRequest(Channel.etrACIS);
            StructCopy<PK_GeneralStatusRequest> StructCopy = new StructCopy<PK_GeneralStatusRequest>();
            byte[] bytes = StructCopy.GetBytes(packet);
            protocolHandler.Send(Channel.etrACIS, bytes);
        }
        ...
        {
            PK_ConfigMemoryRequest packet = new PK_ConfigMemoryRequest(Channel.etrACIS, size, offset, stepsize);
        ...
        {
            PK_ConfigMemoryData packet = new PK_ConfigMemoryData(Channel.etrACIS, size, offset, stepsize, data);
        ...
        {
            PK_TableMemoryData packet = new PK_TableMemoryData(Channel.etrACIS, size, table, offset, stepsize, data);
        ...
        {
            PK_ConfigMemoryAcknowledge packet = new PK_ConfigMemoryAcknowledge(Channel.etrACIS, size, offset, stepsize, errorcode);
        ...
        {
            PK_TableMemoryRequest packet = new PK_TableMemoryRequest(Channel.etrACIS, size, table, offset, stepsize);
        ...
        {
            PK_TableMemoryAcknowledge packet = new PK_TableMemoryAcknowledge(Channel.etrACIS, size, table, offset, stepsize, errorcode);
        ...
        {
            PK_SaveConfig packet = new PK_SaveConfig(Channel.etrACIS);
        ...
        {
            PK_RestoreConfig packet = new PK_RestoreConfig(Channel.etrACIS);
        ...
        {
            PK_DragStart packet = new PK_DragStart(Channel.etrACIS, fromrpm, torpm);
        ...
        {
            PK_DragStop packet = new PK_DragStop(Channel.etrACIS, fromrpm, torpm);
        ...
        {
            PK_DragUpdateRequest packet = new PK_DragUpdateRequest(Channel.etrACIS);
        ...
        {
            PK_DragPointRequest packet = new PK_DragPointRequest(Channel.etrACIS, fromrpm, torpm, point);
